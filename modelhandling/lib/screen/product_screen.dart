...
import 'package:modelhandling/controller/poduct_controller.dart';
...
class _ProductPageState extends State<ProductPage> {
  ...
  void initState() {
   ...
   void addProduct() async {
    if(priceController.text.isEmpty || nameController.text.isEmpty || quantityController.text.isEmpty){
     return;
    }
